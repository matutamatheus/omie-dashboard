              ...
              <tbody>
                {rows.map((row) => (
                  <tr key={row.id} className="border-b border-gray-100 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-750">
                    ...
                    <td className="py-2 px-3 text-right text-gray-500">{row.valorDesconto > 0 ? formatCurrency(row.valorDesconto) : '-'}</td>
                    <td className="py-2 px-3 text-right text-gray-500">{row.valorJuros > 0 ? formatCurrency(row.valorJuros) : '-'}</td>
                    <td className="py-2 px-3 text-right text-gray-500">{row.valorMulta > 0 ? formatCurrency(row.valorMulta) : '-'}</td>
            ...
            <div className="flex items-center justify-between mt-4 px-3">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  disabled={page <= 1}
                  className="p-1.5 rounded-lg bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 disabled:opacity-30"
                >
